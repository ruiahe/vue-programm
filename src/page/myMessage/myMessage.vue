                ...
                <div class="release" v-if='chosen_tab.id == 0'>
                    <div class="state" v-on:click='statement_details(1)'>
                        <div class="state-top container space-between">
                            ...
                            <div class="state-ellipsis" v-on:click='complaint($event,1)'>
                        ...
                        <div class="state-middle">
                            ...
                            <div class="middle-img-list" v-if='true'>
                    ...
                    <div class="state" v-on:click='statement_details(1)'>
                        ...
                        <div class="state-middle">
                            <div class="middle-txt container">
                                回复<span>张俊</span>：日子增加个排序功能呗，加个小记的导入导出功能呗，后期会做网页端吗。一直盯着探记的更新日子增加个排序功能呗，加个小记的导入导出功能呗，后期会做网页端吗。一直盯着探记的更新日子增加个排序功能呗，加个小记的导入导出功能呗，后期会做网页端吗。一直盯着探记的更新日子增加个排序功能呗，加个小记的导入导出功能呗，后期会做网页端吗。一直盯着探记的更新
                            </div>
                            <div class="middle-reply container">
                                ...
                                <div class="reply-con">
                                    这个软件满足了我多重需求。一个APP承包了我想要的很多功能。就是希望在个人情况记录除了体重这些常规这个软件满足了我多重需求。一个APP承包了我想要的很多功能。就是希望在个人情况记录除了体重这些常规…这个软件满足了我多重需求。一个APP承包了我想要的很多功能。就是希望在个人情况记录除了体重这些常规…
                                </div>
                            </div>
                        </div>
                        <div class="state-bottom container space-between">
...
<script>
    ...
    data() {
        return {
            tabList:[
                ...
                {title: '回复我的', chosen: false, num: 0, id: 1},
                {title: '收到的赞', chosen: false, num: 0, id: 2}
            ],
            titleJson:{
                title: '消息',
                toolBol: false,
    ...
    mounted () {
        ...
        // this.chosen_li(this.chosen_tab);
        //创建MeScroll对象
    ...
    methods:{
        ...
        // 获取数据
        getData(size, num, sucCal){
            var url = '';
            switch(this.chosen_tab.id){
                case 0:
                    url = 'app/forum/queryMyIssuedList';
                    break;
                case 1: 
                    url = 'app/forum/replyMyList'
                    break;
                case 2:
                    url = '/app/forum/upMyList';
                    break;
            }
            new Request(url, {
                'pageSize': size,
