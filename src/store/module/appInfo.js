...
const obj = (()=>{
    ...
    switch (status.domain){
        case 'formal':
            ...
            break;
        case 'beta':
            obj['token'] = 'eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIzIiwiaWF0IjoxNTY5NDgwNTgwLCJzdWIiOiIzIiwiaXNzIjoidGFua2UiLCJleHAiOjE1NzIwNzI1ODB9.eioTK6BsLayqeoYqbqXgMlGXJGjQguLRvs8w9k3tSwc';
            break;
    }
